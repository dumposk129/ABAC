 ...
 */
public class SearchBusinessTask extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        if ("searchBusiness".equals(apiCurrent)) {
            ...
            asyncTaskListener.onTaskComplete("searchBusiness", businessConnectionsList);
        }
